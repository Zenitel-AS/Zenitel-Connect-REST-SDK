...
```
cd existing_repo
git remote add origin https://git.zenitel.com/iface/ZenitelConnectRestApiSdk.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.zenitel.com/iface/ZenitelConnectRestApiSdk/-/settings/integrations)
